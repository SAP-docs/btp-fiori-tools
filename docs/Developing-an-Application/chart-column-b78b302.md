...
A chart column can be added to a table that is part of a list report page or in an object page section.
...
-   **Value**: numeric property to represent the chart data.
-   **Maximum Value \(Path\)**: property to represent the maximum possible value in the chart.

The harvey chart contains the following additional properties:
...
-   You can define in which order multiple sort properties apply by moving them up and down within the sort property.
