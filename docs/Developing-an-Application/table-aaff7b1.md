...
Tables are an essential part of the list report page. They are based on the `UI.LineItem` annotation that can be generated along with the application in the SAP Fiori application generator. For more information, see [Overview](overview-66c5b6f.md).

The *Page Editor* enables you to further configure tables by adding columns and actions. For more information, see [Table Actions](table-actions-da1931b.md) and [Table Columns](table-columns-a80d603.md).
...
## Setting the Default Table Filter
