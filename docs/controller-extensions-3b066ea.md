<!-- loio3b066ea83a1946dda52bcbe3b1378c41 -->
...
<a name="loio3b066ea83a1946dda52bcbe3b1378c41__context_jns_z13_tdb"/>
...
1.  In your workspace expand the `webapp` folder and right click the `manifest.appdescr_variant` file and choose *Open Adaptation Editor*.
...
[Upgrade Safe Compatibility Rules](upgrade-safe-compatibility-rules-12e5252.md "")
